...
//    glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    ...
    generateSphere(0.05f, 20, 20, sphereVertices, sphereIndices); // smaller radius and fewer segments for performance
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (int i = 0; i < 10; ++i)
        {
            ...
            float yPosition = (i-5.0)*0.2f;
            model = glm::translate(model, glm::vec3(0.0f, yPosition, 0.0f));
